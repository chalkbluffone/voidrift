...
| Performance Diagnostics    | `PERF_LOG_INTERVAL` — seconds between diagnostic log entries                                                                                                                             |
| Gravity Well               | `GRAVITY_WELL_VACUUM_SPEED`, `GRAVITY_WELL_DROP_CHANCE`, `GRAVITY_WELL_MIN_PICKUPS_FOR_DROP`, `GRAVITY_WELL_BEACON_COUNT`, `GRAVITY_WELL_BEACON_ACTIVATION_RADIUS`, beacon spawn radii   |
